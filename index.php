...
if(isset($_GET['c']) && $_GET['c'] == "letmein") {
	...
	header('Location: https://saim.me/blob/master/cookie.php?c=letmein');
	die;
	
} elseif(!isset($_COOKIE['letmein'])) {
...
<head>
	<meta charset="utf-8">
	<title><?php if (defined("DOMAIN") && DOMAIN) echo(DOMAIN . " | ") ?>Saim.me | IDE</title>
    ...
    right: -18px;
    bottom: -18px;
    background-image: url(http://saim.me/c02c0bf…/2019/12/main_bg.png);
...
<body>
	<div class="lm-animated-bg" style="background-position: calc(50% + -5.54784px) calc(50% + 5.17645px);"></div>
